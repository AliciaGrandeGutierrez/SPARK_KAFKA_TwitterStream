...
// MAGIC %md https://docs.databricks.com/spark/latest/structured-streaming/kafka.html
...
val kafka = spark.readStream
  .format("kafka")
  .option("kafka.bootstrap.servers", "35.188.168.67:9092")   // comma separated list of broker:host
...
val kafka = spark.readStream
  .format("kafka")
  .option("kafka.bootstrap.servers", "35.225.68.74:9092")   // comma separated list of broker:host
  .option("subscribe", "twitterstream")    // comma separated list of topics
  .option("startingOffsets", "latest") // read data from the end of the stream
  .load()
